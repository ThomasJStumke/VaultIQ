      ...
      <div className="hidden lg:flex lg:w-1/2 p-20 flex-col justify-between relative z-10 bg-[#090d16] border-r border-[#1e293b]">
        <div className="space-y-12">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            >
              Academic <span className="text-indigo-400">Governance.</span> Secure.
            </motion.h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 lg:p-24 relative z-10">
        <div className="w-full max-w-md glass-card p-10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[10px] font-black uppercase tracking-widest text-subtle-foreground mb-2">
                Email
              </label>
              <input
                type="email"
                ...
                className="w-full px-4 py-3 bg-surface-tint border border-border rounded-xl text-foreground placeholder:text-subtle-foreground focus:outline-none focus:border-indigo-500/50 transition-colors"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-surface-tint border border-border rounded-2xl text-muted-foreground font-bold hover:bg-surface-tint-strong hover:border-foreground/20 transition-all active:scale-95"
            >
              Create an account
            </button>
          </form>
