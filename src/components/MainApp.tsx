...
export default function MainApp() {
  ...
  }, [mappedRole, activeTab, currentNavItems]);
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[10px] text-subtle-foreground font-black uppercase tracking-wider">{profile?.role}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="flex-1 overflow-y-auto relative z-10 flex flex-col">
        <header className="h-16 glass-header px-8 flex items-center justify-between sticky top-0 z-40">
          ...
          <div className="flex items-center gap-4">
            ...
            {(() => {
              const canUploadHere = !!mappedRole && (
